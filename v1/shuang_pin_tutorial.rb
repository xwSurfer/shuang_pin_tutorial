...
legal_composite= {
    ...
    :D => %w(a e i u ai ei ui ao ou iu ie an en un ang eng ing ong ),
    :T => %w(a e i u ai ei ui ao ou ie an un ang eng ing ong ),
    :N => %w(a e i u ai ei ao ou iu ie ve an en in un ang eng ing ong ),
    :L => %w(a e i u ai ei ao ou iu ie ve an in un ang eng ing ong ),
    :G => %w(a e u ai ei ui ao ou an en un ang eng ong ),
    :K => %w(a e u ai ei ui ao ou an en un ang eng ong ),
    :H => %w(a e u ai ei ui ao ou an en un ang eng ong ),
    :J => %w(i v iu ie ve in un ing ),
    :Q => %w(i v iu ie ve in un ing ),
    :X => %w(i v iu ie ve in un ing ),
    :Z => %w(a e i u ai ei ui ao ou an en un ang eng ong ),
    :C => %w(a e i u ai ei ui ao ou an en un ang eng ong ),
    :S => %w(a e i u ai ui ao ou an en un ang eng ong ),
    :ZH => %w(a e i u ai ei ui ao ou an en un ang eng ong ),
    :CH => %w(a e i u ai ui ao ou an en un ang eng ong ),
    :SH => %w(a e i u ai ei ui ao ou an en un ang eng ),
    :R => %w(e i u ui ao ou an en un ang eng ong ),
